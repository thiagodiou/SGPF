 ...
 * 
 * Observa��o: Ctrl + V digitado rapidamente n�o � captado.
 * 
 * Parametros:
 * Allow: Caracteres que dever�o ser permitidos.
 * Converter [true, false]: True para converter acentos e �; False para n�o converter.
 * 
 */
...
(function($) {
	...
	$.fn.masktextnumeric = function(p) {
		...
		return this.each(function() {
			...
			var acentos  = "ÁÉÍÓÚÀÈÌÒÙÂÊÎÔÛÄËÏÖÜÃÕÇÝáéíóúàèìòùâêîôûäëïöüãõçý";
			...
			$(this).keypress(function(e) {
					...
					// Verifica se o que foi digitado não está na lista de
					// permitidos
					// e.charCode = 0: Backspace, <-, ->, shift + home, shift + end
					// e.charCode = 32, e.which = 32: Espaço
					// alert('k: '+k);
					if ($.browser.msie) {
